    ...
    function Game(){
        ...
        function Adventure(){
            ...
            if(adventure == "look" || adventure == "look around"){
                alert("You breath in the fresh air, the sun is setting in front of you and you look down at your compass. It points towards the golden sun.").toLowerCase;
                    Compass();
                }
        ...
        function FollowCompass(){
            ...
            var followcompass = prompt("You follow the compass instead of entering. You hear a howl grow from within the home behind you. You shake your head, looking at the compass. It leads you back North and you soon grow hungry as you walk. You see a rabbit. /n - Follow rabbit").toLowerCase;
             
            if(followcompass == "follow rabbit"){
                Rabbit();
            }
        }
        ...
        function Rabbit(){
            ...
            else if(rabbit == "leave rabbit alone"){
